...
#define DEMCR		*((volatile uint32_t*)0xE000EDFCU)  //WRC

//ITM Register Address
#define ITM_STIMULUS_PORT0	*((volatile uint32_t*)0xE0000000)  //WRC
#define ITM_TRACE_EN		*((volatile uint32_t*)0xE0000E00)  //WRC
